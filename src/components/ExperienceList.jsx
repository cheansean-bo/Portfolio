...
const ExperiencesList = [
  {
    ...
    points: [
      "Efficiently implemented a catalogue system utilizing VBA automation to match thousands of product images with QR code records in excel",
...

  {
    ...
    points: [
      "Developed a Python-based automation auditing tool to streamline attendance tracking and generate categorized reports",
...

  {
    ...
    points: [
      "Successfully contributed to improving the student portal by efficiently managing the modelling phases and improve usability",
